...
file_put_contents("gif.txt",$Data1 );
	...
	$token = '341683081:AAFGQYJtqhBZRTmcl6q0--sRyaRZkXtIo9g';
	...
	$channel_id = 'https://t.me/mehdiarta1010';
	$label = '@ mehdiarta1010';
	
	$sent = 'پست مورد نظر در کانال ' . $channel_id . ' فرستاده شد 😊' ;
	
	$welcome = 'به ربات کمکی کانال ' .$channel_id . ' خوش آمدید!' . PHP_EOL . PHP_EOL . 'شما هر پستی تو این ربات ارسال کنید ، آی دی استفاده شده در پست و لینک آن به صورت اتوماتیک به آی دی کانال شما تغییر داده شده و به کانال ' . $channel_id . ' اضافه می شود' . PHP_EOL . PHP_EOL . 'طراحی و کدنویسی شده توسط @Sudo_Me' ;
	...
	if( ($username === "Sudo_Me")  ){
		...
		if($type === 1){
			...
			$url .= '&text=' . urlencode("شما درسترسی لازم به این ربات را ندارید. 😐 \nدرصورتی که تمایل به داشتن همچین رباتی هستید به @Sudo_Me مراجعه کنید.") ;
